...
This is a Rust implementation of bionitio.
...
% bionitio-rs -h
Usage:
    bionitio-rs [OPTIONS] [FASTA_FILES ...]
...
```
% bionitio-rs file1.fa file2.fa file3.fa
FILENAME	NUMSEQ	TOTAL	MIN	AVG	MAX
file1.fa	5264	3801855	31	722	53540
...
```
% bionitio-rs --minlen 1000 file.fa
FILENAME	NUMSEQ	TOTAL	MIN	AVG	MAX
...
```
% bionitio-rs two_sequence.fasta 
