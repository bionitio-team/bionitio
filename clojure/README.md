...
This is a Clojure implementation of biotool.
...
We recommend using the `leiningen` tool to install biotool. You will need to install `leiningen` on your system first.
