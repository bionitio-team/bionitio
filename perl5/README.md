...
This is a Perl 5 implementation of biotool.
...
```
% biotool.pl file1.fa file2.fa file3.fa
FILENAME	NUMSEQ	TOTAL	MIN	AVG	MAX
file1.fa	5264	3801855	31	722	53540
...
```
% biotool.pl --minlen 1000 file.fa
FILENAME	NUMSEQ	TOTAL	MIN	AVG	MAX
...
```
% biotool.pl --log bt.log file1.fasta file2.fasta 
# normal biotool output appears here
# contents of log file displayed below
% cat bt.log
2017/04/22 19:41:40 INFO program started
2017/04/22 19:41:40 INFO command line arguments: ./biotool.pl file1.fasta file2.fasta 
