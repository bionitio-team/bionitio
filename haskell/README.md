...
This is a Haskell implementation of biotool.
...
Once you have `stack` installed you can use it to build biotool like so:
...
```
% biotool-hs -h
Usage: biotool-hs [--minlen N] [--version] [--verbose] [[FASTA_FILE ...]]
  Print fasta stats
...
```
% biotool-hs file1.fa file2.fa file3.fa
FILENAME	NUMSEQ	TOTAL	MIN	AVG	MAX
file1.fa	5264	3801855	31	722	53540
...
```
% biotool-hs --minlen 1000 file.fa
FILENAME	NUMSEQ	TOTAL	MIN	AVG	MAX
